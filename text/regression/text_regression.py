...
reg_selector = SelectKBest(score_func=f_regression, k=550)
...
# save data sets - BoW
# train_x = open('X_train_rf.pickle', 'wb')
# pickle.dump(X_train, train_x)
# train_x.close()
#
# train_y = open('y_train_rf.pickle', 'wb')
# pickle.dump(y_train, train_y)
# train_y.close()
#
# test_x = open('X_test_rf.pickle', 'wb')
# pickle.dump(X_test, test_x)
# test_x.close()
#
# test_y = open('y_test_rf.pickle', 'wb')
# pickle.dump(y_test, test_y)
# test_y.close()


# save data sets - TF-IDF
# train_x = open('X_train_r_tf.pickle', 'wb')
# pickle.dump(X_train, train_x)
# train_x.close()
#
# train_y = open('y_train_r_tf.pickle', 'wb')
# pickle.dump(y_train, train_y)
# train_y.close()
#
# test_x = open('X_test_r_tf.pickle', 'wb')
# pickle.dump(X_test, test_x)
# test_x.close()
#
# test_y = open('y_test_r_tf.pickle', 'wb')
# pickle.dump(y_test, test_y)
# test_y.close()
...
def k_cross_validation(model, grid, X=X_train, y=y_train):
    ...
    # save best model
    # file = open(str(model) + '_text_r', 'wb')
...
def random_forest():
    ...
    # try:
    #     file = open(str(model) + '_text_r', 'rb')
...
# def mlp():
#     grid = {'hidden_layer_sizes': [(50, 50, 50), (50, 100, 50), (100,)], 'activation': ['tanh', 'relu'],
